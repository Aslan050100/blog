...
<html lang="{{ app()->getLocale() }}">
	...
	<![endif]-->
	<style type="text/css">
		/*Егер дескрипшн косатн болсан осыны озгерт*/
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="{{route('blog.getSpecialty',[$profession['id'][0],$city,$level,$first_sub,$second_sub])}}" class="fh5co-card-item">
						
						<div class="fh5co-text">
							<h2>{{$profession['name'][0]}}</h2>
							<p>{{$profession['pro_des'][0]}}</p>
							<p><span class="btn btn-primary">Check specialties</span></p>
						</div>
					</a>
				</div>
				@endforeach
