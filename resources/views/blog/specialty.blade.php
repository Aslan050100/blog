...
<nav class="gtco-nav" role="navigation">
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="{{route('blog.getUniversity',[$specialty->spec_id,$city,$level,$pro_id,$first_sub,$second_sub])}}" class="fh5co-card-item">
						@if(app()->getLocale() == 'ru')
						<div class="fh5co-text">
							<h2>{{$specialty->spe_name}}</h2>
							<p>{{$specialty->spe_code}}</p>
							<p><span class="btn btn-primary">Check universities</span></p>
						</div>
						@endif
						@if(app()->getLocale() == 'en')
						<div class="fh5co-text">
							<h2>{{$specialty->spe_name_eng}}</h2>
							<p>{{$specialty->spe_code}}</p>
							<p><span class="btn btn-primary">Check universities</span></p>
						</div>
						@endif
	...
	<span class="pagination">{{$specialties->links()}}</span>
